...
<div class="page-container">
  ...
  <div class="page-sidebar navbar-collapse collapse" >
     <!-- BEGIN SIDEBAR MENU -->        
     <p>&nbsp;</p>
     <ul class="page-sidebar-menu" id="side-nav">
        <li>
          ...
          <div class="col-md-9"> 
                <div class="portlet grey box">
                    <div class="portlet-title">
                     <div class="caption"><i class="icon-globe"></i><span id="active-function-name">Dashboard</span><span id="search-query-display-container" class="pull-right"></span></div>
                     <div class="tools">
                  ...
                  <div class="portlet-body">
                    <div id="data-table-container" style="padding-bottom:5px; overflow:hidden;">
          ...
          <div class="portlet-body">
            <div class="tabbable tabbable-custom">
                <ul class="nav nav-tabs">
                   <li class="active"><a id="form-home-control-handle" data-toggle="tab" href="#form-home">Form</a></li>
                   <li><a id="record-details-home-control-handle" data-toggle="tab" href="#record-details-display-home">Details</a></li>
                   <li><a id="report-card-home-control-handle" data-toggle="tab" href="#report-card-home">Reports</a></li>
                ...
                <div class="tab-content">
                  ...
                  <div class="tab-pane tab-content-to-clear" id="report-card-home" style="max-height:400px; overflow-y:scroll;">
...
<div class="bottom-nav footer"> <span style="font-size:0.8em;">ver <span id="project-version">2014</span></span> </div>
