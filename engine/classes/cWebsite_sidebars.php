<?php
	/**
	 * website_sidebars Class
	 *
	 * @used in  				website_sidebars Function
	 * @created  				13:27 | 05-01-2013
	 * @database table name   	website_sidebars
	 */

	/*
	|--------------------------------------------------------------------------
	| website_sidebars Function in Settings Module
	|--------------------------------------------------------------------------
	|
	...
	*/
	...
	class cwebsite_sidebars{
		public $class_settings = array();
		
		private $current_record_id = '';
		
		private $table_name = 'website_sidebars';
		...
		private $table_fields = array(
			'pages' => 'website_sidebars001',
			'title' => 'website_sidebars002',
			'content_type' => 'website_sidebars003',
			'content_html' => 'website_sidebars004',
			'serial_number' => 'website_sidebars005',
		);
		...
		function website_sidebars(){
			...
			break;
			case 'get_website_sidebars':
				$returned_value = $this->_get_website_sidebars();
			break;
			}
		...
		private function _display_data_table(){
			...
			if($sql_result && is_array($sql_result)){
				...
				$err->class_that_triggered_error = 'cwebsite_sidebars.php';
		...
		private function _get_website_sidebars(){
			...
			if( isset( $this->class_settings['current_record_id'] ) && $this->class_settings['current_record_id'] ){
				...
				$all_website_sidebars = execute_sql_query($query_settings);
				
				$website_sidebars = array();
				
				if( is_array( $all_website_sidebars ) && ! empty( $all_website_sidebars ) ){
					
					foreach( $all_website_sidebars as $category ){
						$pages = explode( ':::', $category[ 'pages' ] );
						foreach( $pages as $page ){
							$website_sidebars[ $page ] = $category;
						}
					}
					
					foreach( $website_sidebars as $page => $sidebar ){
						//Cache Settings
						$settings = array(
