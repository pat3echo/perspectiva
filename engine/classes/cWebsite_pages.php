<?php
	 ...
	 * website_pages Class
	 *
	 * @used in  				website_pages Function
	 * @created  				13:27 | 05-01-2013
	 * @database table name   	website_pages
	 */

	/*
	|--------------------------------------------------------------------------
	| website_pages Function in Settings Module
	|--------------------------------------------------------------------------
	|
	...
	*/
	...
	class cWebsite_pages{
		...
		private $table_fields = array(
			'page_name' => 'website_pages001',
			'title' => 'website_pages002',
			'page_width' => 'website_pages003',
			'times_viewed' => 'website_pages004',
		);
		...
		function website_pages(){
			...
			case 'get_website_pages':
				$returned_value = $this->_get_website_pages();
			break;
			}
		...
		private function _display_data_table(){
			...
			if($sql_result && is_array($sql_result)){
				...
				$err->class_that_triggered_error = 'cwebsite_pages.php';
		...
		private function _get_website_pages(){
			...
			$all_website_pages = execute_sql_query($query_settings);
			
			$website_pages = array();
			
			if( is_array( $all_website_pages ) && ! empty( $all_website_pages ) ){
				
				foreach( $all_website_pages as $category ){
					$website_pages[ $category[ 'page_name' ] ] = $category;
				}
				
				//Cache Settings
				$settings = array(
					'cache_key' => $cache_key,
					'cache_values' => $website_pages,
					'permanent' => true,
				);
