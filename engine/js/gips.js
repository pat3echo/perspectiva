(function ($) {
    $.fn.extend({
        gips: function (options) {
            var settings = $.extend({ delay: 100, autoHide: false, pause: 2000, animationSpeed: 200, placement: 'top', theme: 'purple', imagePath: 'images/close.png', text: 'Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et.' }, options);
            return this.each(function () {
				...
				settings.text = $(this).parent().text().toLowerCase();
                var toolTipContainer = $('<div class="gips-container"><div class="gips-body ' + settings.theme + '">Please ensure that you type in the ' + settings.text + ', starting the sentence with a capital letter.' +
